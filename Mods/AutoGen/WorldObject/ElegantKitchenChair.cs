namespace Eco.Mods.TechTree
{
    ...
    public partial class ElegantKitchenChairObject : WorldObject
    {
        public override string FriendlyName { get { return "Elegant Kitchen Chair"; } } 


        protected override void Initialize()
        {
            this.GetComponent<HousingComponent>().Set(ElegantKitchenChairItem.HousingVal);                                
        ...
        static ElegantKitchenChairObject()
        {
            AddOccupancyList(typeof(ElegantKitchenChairObject), new BlockOccupancy(Vector3i.Zero, typeof(WorldObjectBlock)));
        }
    }

    [Serialized]
    public partial class ElegantKitchenChairItem : WorldObjectItem<ElegantKitchenChairObject>
    {
        public override string FriendlyName { get { return "Elegant Kitchen Chair"; } } 
        public override string Description { get { return "A More Comfortable Chair"; } }

        static ElegantKitchenChairItem()
        {
    ...
    public partial class ElegantKitchenChairRecipe : Recipe
    {
