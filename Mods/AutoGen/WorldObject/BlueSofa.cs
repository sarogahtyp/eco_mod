namespace Eco.Mods.TechTree
{
    ...
    public partial class BlueSofaObject : WorldObject
    {
        public override string FriendlyName { get { return "Blue Sofa"; } } 


        protected override void Initialize()
        {
            this.GetComponent<MinimapComponent>().Initialize("Housing");                                 
            this.GetComponent<HousingComponent>().Set(BlueSofaItem.HousingVal);                                
        ...
        static BlueSofaObject()
        {
            AddOccupancyList(typeof(BlueSofaObject), new BlockOccupancy(Vector3i.Zero, typeof(WorldObjectBlock)));
            AddOccupancyList(typeof(BlueSofaObject), new BlockOccupancy(new Vector3i(-1, 0, 0), typeof(WorldObjectBlock)));
        }
    }

    [Serialized]
    public partial class BlueSofaItem : WorldObjectItem<BlueSofaObject>
    {
        public override string FriendlyName { get { return "Blue Sofa"; } } 
    ...
    public partial class BlueSofaRecipe : Recipe
    {
        public BlueSofaRecipe()
        {
            this.Products = new CraftingElement[]
            {
                new CraftingElement<BlueSofaItem>(),
            };
            ...
            SkillModifiedValueManager.AddBenefitForObject(typeof(BlueSofaRecipe), Item.Get<BlueSofaItem>().UILink(), value);
            SkillModifiedValueManager.AddSkillBenefit(Item.Get<BlueSofaItem>().UILink(), value);
            this.CraftMinutes = value;
            this.Initialize("Blue Sofa", typeof(BlueSofaRecipe));
