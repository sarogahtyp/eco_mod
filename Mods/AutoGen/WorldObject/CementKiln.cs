namespace Eco.Mods.TechTree
{
    ...
    public partial class CementKilnRecipe : Recipe
    {
        public CementKilnRecipe()
        {
            ...
            {
                new CraftingElement<IronIngotItem>(typeof(MetalworkingEfficiencySkill), 70, MetalworkingEfficiencySkill.MultiplicativeStrategy),
                new CraftingElement<GearboxItem>(typeof(MetalworkingEfficiencySkill), 30, MetalworkingEfficiencySkill.MultiplicativeStrategy),
                new CraftingElement<PistonItem>(typeof(MetalworkingEfficiencySkill), 8, MetalworkingEfficiencySkill.MultiplicativeStrategy),
				new CraftingElement<StoneItem>(typeof(MetalworkingEfficiencySkill), 100, MetalworkingEfficiencySkill.MultiplicativeStrategy),
