namespace Eco.Mods.TechTree
{
    ...
    public partial class ToiletObject : WorldObject
    {
        public override string FriendlyName { get { return "Toilet"; } } 
        ...
        static ToiletObject()
        {
            AddOccupancyList(typeof(ToiletObject), new BlockOccupancy(Vector3i.Zero, typeof(WorldObjectBlock)));
        }
    }
    ...
    public partial class ToiletRecipe : Recipe
    {
        public ToiletRecipe()
        {
            ...
            SkillModifiedValueManager.AddBenefitForObject(typeof(ToiletRecipe), Item.Get<ToiletItem>().UILink(), value);
            SkillModifiedValueManager.AddSkillBenefit(Item.Get<ToiletItem>().UILink(), value);
            this.CraftMinutes = value;
            this.Initialize("Toilet", typeof(ToiletRecipe));
