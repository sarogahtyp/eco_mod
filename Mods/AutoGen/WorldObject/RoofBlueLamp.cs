namespace Eco.Mods.TechTree
{
    ...
    public partial class RoofBlueLampObject : WorldObject
    {
        public override string FriendlyName { get { return "Roof Blue Lamp"; } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(RoofBlueLampItem.HousingVal);                                
    ...
    public partial class RoofBlueLampRecipe : Recipe
    {
        public RoofBlueLampRecipe()
        {
            this.Products = new CraftingElement[]
            {
                new CraftingElement<RoofBlueLampItem>(),
            };
            ...
            SkillModifiedValueManager.AddBenefitForObject(typeof(RoofBlueLampRecipe), Item.Get<RoofBlueLampItem>().UILink(), value);
            SkillModifiedValueManager.AddSkillBenefit(Item.Get<RoofBlueLampItem>().UILink(), value);
            this.CraftMinutes = value;
            this.Initialize("Roof Blue Lamp", typeof(RoofBlueLampRecipe));
