namespace Eco.Mods.TechTree
{
    ...
    public partial class PrimitivChemistrySkill : Skill
    {
        public override string FriendlyName { get { return "PrimitivChemistry"; } }
        ...
        {
            new Tuple<Type, int>(typeof(LaboratoryItem), 1),
        };
