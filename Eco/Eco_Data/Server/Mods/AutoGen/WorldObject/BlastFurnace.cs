namespace Eco.Mods.TechTree
{
    ...
    public partial class BlastFurnaceRecipe : Recipe
    {
        public BlastFurnaceRecipe()
        {
            ...
            {
                new CraftingElement<BrickItem>(typeof(MetalworkingEfficiencySkill), 100, MetalworkingEfficiencySkill.MultiplicativeStrategy),
                new CraftingElement<IronIngotItem>(typeof(MetalworkingEfficiencySkill), 100, MetalworkingEfficiencySkill.MultiplicativeStrategy),
