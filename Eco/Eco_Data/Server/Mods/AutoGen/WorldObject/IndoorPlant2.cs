namespace Eco.Mods.TechTree
{
    ...
    public partial class IndoorPlant2Object : WorldObject
    {
        public override string FriendlyName { get { return "Small Indoor Plant"; } } 


        protected override void Initialize()
        {
            this.GetComponent<MinimapComponent>().Initialize("Misc");                                 
            this.GetComponent<HousingComponent>().Set(IndoorPlant2Item.HousingVal);                                
        ...
        static IndoorPlant2Object()
        {
            AddOccupancyList(typeof(IndoorPlant2Object), new BlockOccupancy(Vector3i.Zero, typeof(WorldObjectBlock)));
        }
    }

    [Serialized]
    public partial class IndoorPlant2Item : WorldObjectItem<IndoorPlant2Object>
    {
        public override string FriendlyName { get { return "Small Indoor Plant"; } } 
        public override string Description { get { return "Evergreen!!"; } }

        static IndoorPlant2Item()
        {
    ...
    public partial class IndoorPlant2Recipe : Recipe
    {
