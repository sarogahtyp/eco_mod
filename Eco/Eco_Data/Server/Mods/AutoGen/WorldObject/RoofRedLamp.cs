namespace Eco.Mods.TechTree
{
    ...
    public partial class RoofRedLampObject : WorldObject
    {
        public override string FriendlyName { get { return "Roof Red Lamp"; } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(RoofRedLampItem.HousingVal);                                
    ...
    public partial class RoofRedLampRecipe : Recipe
    {
        public RoofRedLampRecipe()
        {
            this.Products = new CraftingElement[]
            {
                new CraftingElement<RoofRedLampItem>(),
            };
            ...
            SkillModifiedValueManager.AddBenefitForObject(typeof(RoofRedLampRecipe), Item.Get<RoofRedLampItem>().UILink(), value);
            SkillModifiedValueManager.AddSkillBenefit(Item.Get<RoofRedLampItem>().UILink(), value);
            this.CraftMinutes = value;
            this.Initialize("Roof Red Lamp", typeof(RoofRedLampRecipe));
