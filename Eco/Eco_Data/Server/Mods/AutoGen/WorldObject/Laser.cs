namespace Eco.Mods.TechTree
{
    ...
    public partial class LaserRecipe : Recipe
    {
        public LaserRecipe()
        {
            ...
            {
                new CraftingElement<GoldIngotItem>(typeof(ElectronicEngineeringEfficiencySkill), 500, ElectronicEngineeringEfficiencySkill.MultiplicativeStrategy),
				...
				new CraftingElement<GlassItem>(typeof(ElectronicEngineeringEfficiencySkill), 300, ElectronicEngineeringEfficiencySkill.MultiplicativeStrategy),
				new CraftingElement<ElectricMotorItem>(typeof(ElectronicEngineeringEfficiencySkill), 5, ElectronicEngineeringEfficiencySkill.MultiplicativeStrategy),
				new CraftingElement<RivetItem>(typeof(IndustrialEngineeringEfficiencySkill), 100, IndustrialEngineeringEfficiencySkill.MultiplicativeStrategy),	
            };
