namespace Eco.Mods.TechTree
{
    ...
    public partial class KilnRecipe : Recipe
    {
        public KilnRecipe()
        {
            ...
            {
                new CraftingElement<StoneItem>(typeof(StoneworkingEfficiencySkill), 100, StoneworkingEfficiencySkill.MultiplicativeStrategy),
				new CraftingElement<BrickItem>(typeof(StoneworkingEfficiencySkill), 50, StoneworkingEfficiencySkill.MultiplicativeStrategy),				
            };
