namespace Eco.Mods.TechTree
{
    ...
    public partial class ElegantSinkObject : WorldObject
    {
        public override string FriendlyName { get { return "Elegant Sink"; } } 


        protected override void Initialize()
        {
            this.GetComponent<MinimapComponent>().Initialize("Misc");                                 
            this.GetComponent<HousingComponent>().Set(ElegantSinkItem.HousingVal);                                
        ...
        static ElegantSinkObject()
        {
            AddOccupancyList(typeof(ElegantSinkObject), new BlockOccupancy(Vector3i.Zero, typeof(WorldObjectBlock)));
        }
    }

    [Serialized]
    public partial class ElegantSinkItem : WorldObjectItem<ElegantSinkObject>
    {
        public override string FriendlyName { get { return "Elegant Sink"; } } 
        public override string Description { get { return "Wash Your Hands!!"; } }

        static ElegantSinkItem()
        {
    ...
    public partial class ElegantSinkRecipe : Recipe
    {
